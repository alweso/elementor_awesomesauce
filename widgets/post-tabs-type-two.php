...
* @since 1.1.0
*/
class PostTabsTypeTwo extends Widget_Base {
...
public function get_title() {
  return __( 'Post Tabs Type Two', 'elementor-post-tabs-type-two' );
}
      ...
      <?php if ( $query->have_posts() ) : ?>
        <div class="row">
          <?php while ($query->have_posts()) : $query->the_post(); ?>
            ...
            <?php if ( $i == 1 ) : ?>
              <div class="col-6">
                <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>" style=""><?php the_post_thumbnail('medium-horizontal'); ?></a>
                       <h5><?php the_title();?></h5>
                       <?php the_excerpt() ?>
              ...
              <?php else : ?>
                <div class="col-6">
                  <a href="<?php echo esc_url( get_permalink() ); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>" style="float:left;margin-right:20px;"><?php the_post_thumbnail('small-horizontal'); ?></a>
                       <h5><?php the_title();?></h5>
              <?php if($show_date == 'yes') { ?>
                <span class="post-date"> <i class="fa fa-clock-o"></i> <?php echo get_the_date(get_option('date_format')); ?></span>
              <?php } ?>
